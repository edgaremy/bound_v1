...
# Usage example
images_path = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT1/dataset(prediction)/images'
labels_path = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT1/dataset(prediction)/labels'
csv_file = 'labels.csv'
