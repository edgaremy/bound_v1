...
# Usage example
images_path = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT4/Pictures'
labels_path = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT4/dataset(prediction)/labels'
csv_file = 'labels.csv'
