...
#model = YOLO('/home/edgarremy/Documents/CODE/bound_v1/runs/detect/train4/weights/best.pt')


# Use the model
model.train(data="/mnt/disk1/datasets/Lepinoc_2022/splitted_dataset/Task_Lepinoc/Task Lepinoc.yaml", epochs=1)  # train the model
