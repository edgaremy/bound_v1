...
# Example usage
labels_input_folder = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT4/dataset(prediction)/labels_validated'
labels_output_folder = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT4/dataset/labels'
image_input_folder = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT4/Pictures'
image_output_folder = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT4/dataset/images'
train_ratio = 0.9
val_ratio = 0.1
