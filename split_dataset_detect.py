...
def split_dataset(labels_input_folder, labels_output_folder, image_input_folder, image_output_folder, train_ratio, val_ratio, test_ratio):
...
# Example usage
labels_input_folder = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT1/dataset(prediction)/labels_validated'
labels_output_folder = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT1/dataset/labels'
image_input_folder = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT1/dataset(prediction)/images'
image_output_folder = '/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT1/dataset/images'
train_ratio = 0.9
val_ratio = 0.1
test_ratio = 0.0 # test_ratio equals (1 - train_ratio - val_ratio)

split_dataset(labels_input_folder, labels_output_folder, image_input_folder, image_output_folder, train_ratio, val_ratio, test_ratio)