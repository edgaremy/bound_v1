...
model = YOLO('runs/detect/train24/weights/best.pt') # load best.pt or last.pt of local model
...
folder_path = "/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT5/Pictures"
