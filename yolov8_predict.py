...
model = YOLO('runs/detect/train23/weights/best.pt') # load best.pt or last.pt of local model
...
folder_path = "/mnt/disk1/datasets/iNaturalist/Arthropods/LIMIT4/Pictures"
