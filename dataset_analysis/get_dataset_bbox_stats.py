...
# Example usage:
dataset_folder = "/mnt/disk1/datasets/iNaturalist/Arthropods/dataset17"
mean_bbox_size, mean_bboxes_per_image = get_bbox_stats(dataset_folder)
print(f"Mean bounding box size: {mean_bbox_size:.2f}%")
print(f"Mean number of bounding boxes per image: {mean_bboxes_per_image:.2f}")